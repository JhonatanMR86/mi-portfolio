...
class Frame(tk.Frame):
    ...
    def campos_pelicula(self):
        ...
        #Entrys de cada campo(campos de entrada)
    ...
    def editar_datos(self):
        try:
            ...
            self.entry_duracion.insert(1,self.duracion_pelicula)
            self.entry_genero.insert(2,self.genero_pelicula)
        except:
